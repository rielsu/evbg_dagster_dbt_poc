...
DBT_PROJECT_PATH = file_relative_path(__file__, "../../evbg_dbt_project")
DBT_PROFILES = file_relative_path(__file__, "../../evbg_dbt_project/config")
...
dbt_local_assets = load_assets_from_dbt_project(
    project_dir=DBT_PROJECT_PATH, profiles_dir=DBT_PROFILES,key_prefix=["evbg"]
)
